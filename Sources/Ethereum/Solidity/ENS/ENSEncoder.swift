...
public final class ENSEncoder {
    ...
    public static func encodeSetResolver(node: Data, resolver: MoacAddress) -> Data {
    ...
    public static func encodeSetOwner(node: Data, owner: MoacAddress) -> Data {
    ...
    public static func encodeSetSubnodeOwner(node: Data, label: Data, owner: MoacAddress) -> Data {
