...
public final class ERC20Encoder {
    ...
    public static func encodeBalanceOf(address: MoacAddress) -> Data {
    ...
    public static func encodeAllowance(owner: MoacAddress, spender: MoacAddress) -> Data {
    ...
    public static func encodeTransfer(to: MoacAddress, tokens: BigUInt) -> Data {
    ...
    public static func encodeApprove(spender: MoacAddress, tokens: BigUInt) -> Data {
    ...
    public static func encodeTransfer(from: MoacAddress, to: MoacAddress, tokens: BigUInt) -> Data {
